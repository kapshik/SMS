...
public class InvoiceReportServiceImpl implements InvoiceReportService  {
	...
	@Autowired
	InvoiceTableModelFactory invoiceReportFactory;
	...
	public void mekeInvoice(HttpServletResponse response, String option) throws IOException, JRException {
		...
		Collection<Map<String, ?>> source = invoiceReportFactory.makeList();
		Map<String, Object> parameters = invoiceReportFactory.makeParameters();
