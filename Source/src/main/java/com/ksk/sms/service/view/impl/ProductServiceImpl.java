...
@Service
public class ProductServiceImpl implements  SmsViewService<ProductViewModel> {
    ...
    public ProductViewModel init() {
		...
		outModel.setCriteria(makeProductModel("XX"));
    ...
    public ProductViewModel search(ProductViewModel inModel) {
		...
		outModel.setDetail(makeProductModel("XX"));

		outModel.setOrderDetail(makeOrderModel("YY"));
