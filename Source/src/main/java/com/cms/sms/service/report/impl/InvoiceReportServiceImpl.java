package com.cms.sms.service.report.impl;
...
import com.cms.sms.presentation.controller.CommonController;
import com.cms.sms.service.report.InvoiceReportService;
...
//		String outFileName = "Invoice_" + LocalDate.now() + ".pdf";
		String outFileName = "請求書_" + LocalDate.now() + ".pdf";
